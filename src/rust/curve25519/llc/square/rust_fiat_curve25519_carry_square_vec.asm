.text
	...
	.globl	rust_fiat_curve25519_carry_square_vec # -- Begin function rust_fiat_curve25519_carry_square
	.p2align	4, 0x90
	.type	rust_fiat_curve25519_carry_square_vec,@function
rust_fiat_curve25519_carry_square_vec:      # @rust_fiat_curve25519_carry_square
	.cfi_startproc
# %bb.0:                                # %start
	push	rbp
