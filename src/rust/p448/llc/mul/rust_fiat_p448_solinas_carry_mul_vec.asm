.text
	...
	.file	"rust_fiat_p448_solinas_carry_mul.b8389f6bccc81cb3-cgu.0"
	.globl	rust_fiat_p448_solinas_carry_mul_vec # -- Begin function rust_fiat_p448_solinas_carry_mul
	.p2align	4, 0x90
	.type	rust_fiat_p448_solinas_carry_mul_vec,@function
rust_fiat_p448_solinas_carry_mul_vec:       # @rust_fiat_p448_solinas_carry_mul_vec
	.cfi_startproc
# %bb.0:                                # %start
	push	rbp
	...
	mulx	rdx, rsi, r8
	mov	qword ptr [rsp + 560], rsi      # 8-byte Spill
	...
	mov	rdx, r13
	mulx	rdx, r14, qword ptr [rsp - 120] # 8-byte Folded Reload
	...
	mov	rdx, rsi
	mulx	r13, rbp, qword ptr [rsp - 8]   # 8-byte Folded Reload
	mulx	rdx, r14, r8
	...
	adc	qword ptr [rsp - 32], rax       # 8-byte Folded Spill
	mov	r10, qword ptr [rsp + 360]      # 8-byte Reload
	add	r10, qword ptr [rsp + 544]      # 8-byte Folded Reload
	mov	r8, qword ptr [rsp + 368]       # 8-byte Reload
	adc	r8, qword ptr [rsp + 568]       # 8-byte Folded Reload
	add	r10, qword ptr [rsp + 520]      # 8-byte Folded Reload
	adc	r8, qword ptr [rsp + 528]       # 8-byte Folded Reload
	shld	r12, r11, 8
	bzhi	rax, r11, rdx
	...
	mov	r15, qword ptr [rsp + 560]      # 8-byte Reload
	add	rax, r15
	...
	mov	r14, qword ptr [rsp + 328]      # 8-byte Reload
	add	rax, r14
	...
	mov	rbx, qword ptr [rsp + 344]      # 8-byte Reload
	add	rax, rbx
	mov	rbp, qword ptr [rsp + 352]      # 8-byte Reload
	adc	r11, rbp
	...
	adc	rax, qword ptr [rsp - 80]       # 8-byte Folded Reload
	add	r10, r15
	adc	rax, qword ptr [rsp - 72]       # 8-byte Folded Reload
	add	r10, qword ptr [rsp + 80]       # 8-byte Folded Reload
	adc	rax, qword ptr [rsp + 96]       # 8-byte Folded Reload
	...
	mulx	rax, rcx, qword ptr [rsp - 120] # 8-byte Folded Reload
	mov	qword ptr [rsp - 80], rcx       # 8-byte Spill
	mov	qword ptr [rsp - 120], rax      # 8-byte Spill
	mulx	rdx, rsi, qword ptr [rsp + 40]  # 8-byte Folded Reload
	add	r8, rsi
	adc	rbx, rdx
	add	r8, r12
	adc	rbx, 0
	...
	add	r8, r12
	adc	r10, r15
	add	r8, qword ptr [rsp + 456]       # 8-byte Folded Reload
	adc	r10, qword ptr [rsp + 464]      # 8-byte Folded Reload
	...
	shld	r9, rbx, 8
	add	r9, qword ptr [rsp - 88]        # 8-byte Folded Reload
	mov	al, 56
	bzhi	rcx, r9, rax
	shr	r9, 56
