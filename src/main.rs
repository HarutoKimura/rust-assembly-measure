...
mod cryptopt_fiat_p256 {
    pub const LOOSE_BOUND: u64 = u64::MAX;
    pub const SIZE: usize = 4;
    extern "C" {
        pub fn fiat_p256_mul_gcc(arg0: *const u64, arg1: *const u64, arg2: *const u64);
        pub fn fiat_p256_mul_clang(arg0: *const u64, arg1: *const u64, arg2: *const u64);
        pub fn fiat_p256_mul(arg0: *const u64, arg1: *const u64, arg2: *const u64);
...
mod cryptopt_fiat_p384 {
    pub const LOOSE_BOUND: u64 = u64::MAX;
    pub const SIZE: usize = 6;
    extern "C" {
        pub fn fiat_p384_mul_gcc(arg0: *const u64, arg1: *const u64, arg2: *const u64);
        pub fn fiat_p384_mul_clang(arg0: *const u64, arg1: *const u64, arg2: *const u64);
        pub fn fiat_p384_mul(arg0: *const u64, arg1: *const u64, arg2: *const u64);
...
mod cryptopt_fiat_p434 {
    pub const LOOSE_BOUND: u64 = u64::MAX;
    pub const SIZE: usize = 7;
    extern "C" {
        pub fn fiat_p434_mul_gcc(arg0: *const u64, arg1: *const u64, arg2: *const u64);
        pub fn fiat_p434_mul_clang(arg0: *const u64, arg1: *const u64, arg2: *const u64);
        pub fn fiat_p434_mul(arg0: *const u64, arg1: *const u64, arg2: *const u64);
...
mod cryptopt_fiat_p448_solinas {
    pub const LOOSE_BOUND: u64 = 0x0300_0000_0000_0000;
    pub const SIZE: usize = 8;
    extern "C" {
        pub fn fiat_p448_solinas_carry_mul_gcc(
            arg0: *const u64,
            arg1: *const u64,
            arg2: *const u64,
        );
        ...
        pub fn fiat_p448_solinas_carry_mul(arg0: *const u64, arg1: *const u64, arg2: *const u64);
...
mod cryptopt_fiat_p521 {
    ...
    extern "C" {
        pub fn fiat_p521_carry_mul_gcc(arg0: *const u64, arg1: *const u64, arg2: *const u64);
        pub fn fiat_p521_carry_mul_clang(arg0: *const u64, arg1: *const u64, arg2: *const u64);
        pub fn fiat_p521_carry_mul(arg0: *const u64, arg1: *const u64, arg2: *const u64);
...
mod cryptopt_fiat_secp256k1_dettman {
    ...
    extern "C" {
        pub fn fiat_secp256k1_dettman_mul_gcc(arg0: *const u64, arg1: *const u64, arg2: *const u64);
        pub fn fiat_secp256k1_dettman_mul_clang(
            arg0: *const u64,
            arg1: *const u64,
            arg2: *const u64,
        );
        pub fn fiat_secp256k1_dettman_mul(arg0: *const u64, arg1: *const u64, arg2: *const u64);
...
mod cryptopt_fiat_secp256k1_montgomery {
    pub const LOOSE_BOUND: u64 = u64::MAX;
    pub const SIZE: usize = 4;
    extern "C" {
        ...
        pub fn fiat_secp256k1_montgomery_mul(arg0: *const u64, arg1: *const u64, arg2: *const u64);
...
impl CurveType {
    fn get_params(&self) -> (u64, usize) {
        match self {
            ...
            CurveType::CryptoptFiatP256 => {
                (cryptopt_fiat_p256::LOOSE_BOUND, cryptopt_fiat_p256::SIZE)
            }
            CurveType::CryptoptFiatP384 => {
                (cryptopt_fiat_p384::LOOSE_BOUND, cryptopt_fiat_p384::SIZE)
            }
            CurveType::CryptoptFiatP434 => {
                (cryptopt_fiat_p434::LOOSE_BOUND, cryptopt_fiat_p434::SIZE)
            }
            ...
            CurveType::CryptoptFiatSecp256k1Dettman => (
                cryptopt_fiat_secp256k1_dettman::LOOSE_BOUND,
                cryptopt_fiat_secp256k1_dettman::SIZE,
            ),
            CurveType::CryptoptFiatSecp256k1Montgomery => (
                cryptopt_fiat_secp256k1_montgomery::LOOSE_BOUND,
                cryptopt_fiat_secp256k1_montgomery::SIZE,
            ),
    ...
    fn get_mul_functions(&self) -> Function {
        match self {
            ...
            CurveType::CryptoptFiatSecp256k1Dettman => Function::U64Mul(
            ...
            CurveType::CryptoptFiatSecp256k1Montgomery => Function::U64Mul(
    ...
    fn get_square_functions(&self) -> Function {
        match self {
            ...
            CurveType::CryptoptFiatSecp256k1Dettman => Function::U64Square(
            ...
            CurveType::CryptoptFiatSecp256k1Montgomery => Function::U64Square(
    ...
    fn mul_display_labels(&self) -> (&'static str, &'static str, &'static str) {
        match self {
            ...
            CurveType::CryptoptFiatP256 => {
                ("GCC Baseline", "Clang Baseline", "CryptOpt Ratio17527")
            }
            CurveType::CryptoptFiatP384 => {
                ("GCC Baseline", "Clang Baseline", "CryptOpt Ratio17232")
            }
            CurveType::CryptoptFiatP434 => {
                ("GCC Baseline", "Clang Baseline", "CryptOpt Ratio19146")
            }
            CurveType::CryptoptFiatP448Solinas => {
                ("GCC Baseline", "Clang Baseline", "CryptOpt Ratio13296")
            }
            CurveType::CryptoptFiatSecp256k1Dettman => {
                ("GCC Baseline", "Clang Baseline", "CryptOpt Ratio11508")
            }
            CurveType::CryptoptFiatSecp256k1Montgomery => {
                ("GCC Baseline", "Clang Baseline", "CryptOpt Ratio18998")
            }
            CurveType::CryptoptFiatPoly1305 => {
    ...
    fn square_display_labels(&self) -> (&'static str, &'static str, &'static str) {
        match self {
            ...
            CurveType::CryptoptFiatP256 => {
                ("GCC Baseline", "Clang Baseline", "CryptOpt Ratio17019")
            }
            CurveType::CryptoptFiatP384 => {
                ("GCC Baseline", "Clang Baseline", "CryptOpt Ratio16784")
            }
            CurveType::CryptoptFiatP434 => {
                ("GCC Baseline", "Clang Baseline", "CryptOpt Ratio18549")
            }
            CurveType::CryptoptFiatP448Solinas => {
                ("GCC Baseline", "Clang Baseline", "CryptOpt Ratio11436")
            }
            CurveType::CryptoptFiatSecp256k1Dettman => {
                ("GCC Baseline", "Clang Baseline", "CryptOpt Ratio11258")
            }
            CurveType::CryptoptFiatSecp256k1Montgomery => {
                ("GCC Baseline", "Clang Baseline", "CryptOpt Ratio17679")
            }
            CurveType::CryptoptFiatPoly1305 => {
...
fn main() {
    ...
    let curve_type = match args[1].as_str() {
        ...
        "cryptopt_fiat_p256" => CurveType::CryptoptFiatP256,
        ...
        "cryptopt_fiat_secp256k1_dettman" => CurveType::CryptoptFiatSecp256k1Dettman,
        "cryptopt_fiat_secp256k1_montgomery" => CurveType::CryptoptFiatSecp256k1Montgomery,
