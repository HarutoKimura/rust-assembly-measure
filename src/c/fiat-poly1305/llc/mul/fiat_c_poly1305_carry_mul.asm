	...
	.file	"fiat_c_poly1305_carry_mul.c"
	.globl	fiat_c_poly1305_carry_mul       # -- Begin function fiat_c_poly1305_carry_mul
	.p2align	4, 0x90
	.type	fiat_c_poly1305_carry_mul,@function
fiat_c_poly1305_carry_mul:              # @fiat_c_poly1305_carry_mul
	.cfi_startproc
# %bb.0:
	push	rbp
