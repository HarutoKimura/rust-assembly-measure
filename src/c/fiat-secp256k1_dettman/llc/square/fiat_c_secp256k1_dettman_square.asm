	...
	.file	"fiat_c_secp256k1_dettman_square.c"
	.globl	fiat_c_secp256k1_dettman_square # -- Begin function fiat_c_secp256k1_dettman_square
	.p2align	4, 0x90
	.type	fiat_c_secp256k1_dettman_square,@function
fiat_c_secp256k1_dettman_square:        # @fiat_c_secp256k1_dettman_square
	.cfi_startproc
# %bb.0:
	push	rbp
