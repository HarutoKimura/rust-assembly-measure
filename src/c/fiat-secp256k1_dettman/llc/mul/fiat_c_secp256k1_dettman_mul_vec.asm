	...
	.file	"c_fiat_secp256k1_dettman_mul.c"
	.globl	fiat_c_secp256k1_dettman_mul_vec    # -- Begin function c_fiat_secp256k1_dettman_mul
	.p2align	4, 0x90
	.type	fiat_c_secp256k1_dettman_mul_vec,@function
fiat_c_secp256k1_dettman_mul_vec:           # @c_fiat_secp256k1_dettman_mul
	.cfi_startproc
# %bb.0:
	push	rbp
