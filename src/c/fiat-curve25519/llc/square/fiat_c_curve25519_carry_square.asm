	...
	.file	"fiat_c_curve25519_carry_square.c"
	.globl	fiat_c_curve25519_carry_square  # -- Begin function fiat_c_curve25519_carry_square
	.p2align	4, 0x90
	.type	fiat_c_curve25519_carry_square,@function
fiat_c_curve25519_carry_square:         # @fiat_c_curve25519_carry_square
	.cfi_startproc
# %bb.0:
	push	rbp
