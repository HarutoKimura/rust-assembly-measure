	...
	.file	"c_fiat_curve25519_carry_mul.c"
	.globl	fiat_c_curve25519_carry_mul_vec          # -- Begin function c_fiat_25519_carry_mul
	.p2align	4, 0x90
	.type	fiat_c_curve25519_carry_mul_vec,@function
fiat_c_curve25519_carry_mul_vec:                 # @c_fiat_25519_carry_mul
	.cfi_startproc
# %bb.0:
	push	rbp
	...
	ret
.Lfunc_end0:
	.size	c_fiat_25519_carry_mul, .Lfunc_end0-c_fiat_25519_carry_mul
	.cfi_endproc
                                        # -- End function
