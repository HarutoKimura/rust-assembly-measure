...
extern void fiat_c_secp256k1_dettman_square_CryptOpt(uint64_t* out, const uint64_t* arg1);
...
int main() {
    ...
    fiat_c_secp256k1_dettman_square_CryptOpt(public_output, secret_input);
