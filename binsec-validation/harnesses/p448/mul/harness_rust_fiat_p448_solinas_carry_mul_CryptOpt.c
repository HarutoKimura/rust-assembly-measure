...
extern void rust_fiat_p448_solinas_carry_mul_CryptOpt(uint64_t* out, const uint64_t* arg1, const uint64_t* arg2);
...
int main() {
    ...
    rust_fiat_p448_solinas_carry_mul_CryptOpt(public_output, secret_input1, secret_input2);
