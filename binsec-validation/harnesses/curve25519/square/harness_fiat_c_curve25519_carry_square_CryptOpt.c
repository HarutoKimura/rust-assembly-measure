...
extern void fiat_c_curve25519_carry_square_CryptOpt(uint64_t* out, const uint64_t* arg1);
...
int main() {
    ...
    fiat_c_curve25519_carry_square_CryptOpt(public_output, secret_input);
