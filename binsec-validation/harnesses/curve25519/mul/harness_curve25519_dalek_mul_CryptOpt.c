...
extern void curve25519_dalek_mul_CryptOpt(uint64_t* out, const uint64_t* arg1, const uint64_t* arg2);
...
int main() {
    ...
    curve25519_dalek_mul_CryptOpt(public_output, secret_input1, secret_input2);
