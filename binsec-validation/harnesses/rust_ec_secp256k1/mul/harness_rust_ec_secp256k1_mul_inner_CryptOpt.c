...
extern void rust_ec_secp256k1_mul_inner_CryptOpt(uint64_t* out, const uint64_t* arg1, const uint64_t* arg2);
...
int main() {
    ...
    rust_ec_secp256k1_mul_inner_CryptOpt(public_output, secret_input1, secret_input2);
